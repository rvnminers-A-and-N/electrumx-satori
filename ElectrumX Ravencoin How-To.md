...
- Check [https](https://github.com/RavenProject/Ravencoin/releases)[://](https://github.com/RavenProject/Ravencoin/releases)[github](https://github.com/RavenProject/Ravencoin/releases)[.](https://github.com/RavenProject/Ravencoin/releases)[com](https://github.com/RavenProject/Ravencoin/releases)[/](https://github.com/RavenProject/Ravencoin/releases)[RavenProject](https://github.com/RavenProject/Ravencoin/releases)[/](https://github.com/RavenProject/Ravencoin/releases)[Ravencoin](https://github.com/RavenProject/Ravencoin/releases)[/](https://github.com/RavenProject/Ravencoin/releases)[releases](https://github.com/RavenProject/Ravencoin/releases) for the latest release of  raven-x.x.x.x-x86\_64-linux-gnu.zip. Download (e.g. through **wget**) and unpack the archive inside the zip – this will probably require installing unzip through **sudo apt install unzip**.
...
- At this point you could install some script or service into /etc/systemd/system to run the node automatically at server startup. This ensures a 24/7 operation in case of an unexpected server restart due to system update or maintenance. You could also install watch-dog scripts to restart the server in case of a crash, however, this is beyond the scope of this document. See [https](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[://](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[medium](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[.](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[com](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[/@](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[benmorel](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[/](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[creating](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[-](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[a](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[-](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[linux](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[-](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[service](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[-](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[with](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[-](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[systemd](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[-611](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[b](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[5](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[c](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[8](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[b](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[91](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[d](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6)[6](https://medium.com/@benmorel/creating-a-linux-service-with-systemd-611b5c8b91d6) for an example.
...
Full documentation and information about installation / running of the electrumx server can be found at [https](https://electrumx-ravencoin.readthedocs.io/en/latest/)[://](https://electrumx-ravencoin.readthedocs.io/en/latest/)[electrumx](https://electrumx-ravencoin.readthedocs.io/en/latest/)[-](https://electrumx-ravencoin.readthedocs.io/en/latest/)[ravencoin](https://electrumx-ravencoin.readthedocs.io/en/latest/)[.](https://electrumx-ravencoin.readthedocs.io/en/latest/)[readthedocs](https://electrumx-ravencoin.readthedocs.io/en/latest/)[.](https://electrumx-ravencoin.readthedocs.io/en/latest/)[io](https://electrumx-ravencoin.readthedocs.io/en/latest/)[/](https://electrumx-ravencoin.readthedocs.io/en/latest/)[en](https://electrumx-ravencoin.readthedocs.io/en/latest/)[/](https://electrumx-ravencoin.readthedocs.io/en/latest/)[latest](https://electrumx-ravencoin.readthedocs.io/en/latest/)[/](https://electrumx-ravencoin.readthedocs.io/en/latest/). This is also the place to look first if you run into issues with the following guide, which only briefly describes the steps required. 
...
- See [https](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[://](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[electrumx](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[-](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[ravencoin](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[.](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[readthedocs](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[.](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[io](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[/](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[en](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[/](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[latest](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[/](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[environment](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[.](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html)[html](https://electrumx-ravencoin.readthedocs.io/en/latest/environment.html) for a full list of environment variables. You should at least briefly look over this to see if you need to change anything for your server and what to change/add to the above step.
